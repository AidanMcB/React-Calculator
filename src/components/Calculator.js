        ...
        return (
            <div className="full-calc">
                ...
                <div className="btn-grid">
                    <div className="row1">
                        <button onClick={(e) => this.props.handleClick(e.target.name) } className="open-par" name="(">(</button>
                        <button onClick={(e) => this.props.handleClick(e.target.name) } className="closed-par" name=")">)</button>
